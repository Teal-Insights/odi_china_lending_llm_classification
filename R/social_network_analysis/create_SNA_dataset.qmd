...
processed_cofinanced_loans <- cofinanced_loans_unique_lenders |>
  ...
  # Step 3: Define lender profit orientation.
  # Classify each lender into one of three groups:
  #   - Profit Maximizing: Commercial lenders (i.e., "Private Sector").
  #   - Mixed Mandate: State-owned or joint venture entities that blend commercial and policy roles.
  #   - Policy Driven: Institutions with a clear focus on policy/development (e.g., policy banks, government agencies, MDBs).
  ...
  select(
    ...
    standardized_lender_type,
    lender_geography,          # newly created: "Chinese" or "Non-Chinese"
