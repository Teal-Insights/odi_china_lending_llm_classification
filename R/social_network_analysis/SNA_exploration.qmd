...
network_overall <- build_cofinancing_network(data_for_sna, top_n = 25, min_collabs = 1)
...
network_green <- build_cofinancing_network(data_for_sna, transaction_class = "GREEN", top_n = 25, min_collabs = 1)
